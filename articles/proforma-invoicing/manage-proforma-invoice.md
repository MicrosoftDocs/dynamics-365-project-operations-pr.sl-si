...
---
# <a name="manage-a-proforma-invoice"></a>Upravljanje predračuna
...
| **Podjetje, ki zagotavlja vire** | Privzeto nastavljeno iz vira dejanskega dela. Polje »samo za branje«, ki je zaklenjeno za urejanje. | Polje lahko uredite v novi podrobnosti vrstice računa, ki ne temelji na viru dejanskega dela. |
