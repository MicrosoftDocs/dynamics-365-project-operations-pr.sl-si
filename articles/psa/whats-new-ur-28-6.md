...
description: V tem članku so navedene funkcije in popravki, ki so na voljo v aplikaciji Project Service Automation 28.6, sprotni popravek, V3.
author: ruhercul
...
V tem članku so navedene funkcije in popravki, ki so novi ali spremenjeni za Project Service Automation V3, izdaja posodobitve 28.6. Ta različica ima številko graditve V3.10.46.147 in je splošno na voljo s samostojno posodobitvijo v januarju 2021.
