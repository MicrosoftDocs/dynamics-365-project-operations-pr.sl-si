...
1. Na strani **Projekti** na zavihku **Ekipa** izberite **Novo**, da rezervirate splošni vir.
    ...
    ![Rezervacija splošnega vira v ekipi.](media/Resource-Management-image9.png)
...
4. V pogovornem oknu **Hitro ustvarjanje: lastnosti zahteve**, ki se prikaže, v polju **Lastnost** izberite zahtevano znanje. Nato v polju **Vrednost ocene** izberite stopnjo usposobljenosti za to znanje. Na koncu v polju **Zahtevani pogoj za vir** nastavite zahtevane pogoje za izvorne vire iz organizacijskih enot ali celo poimenovanih virov. Ko končate, izberite **Shrani**.
    ...
    ![Pogovorno okno »Hitro ustvarjanje: lastnosti zahteve«.](media/Resource-Management-image12.png)
...
9. Vrnite se v pogled **Vsi člani ekipe**. V mreži lahko vidite, da je bil splošni vir zamenjan s poimenovanim virom in da je 40 ur navedenih kot rezerviranih za ta vir.
    ...
    ![Posodobljena mreža v pogledu »Vsi člani ekipe«.](media/Resource-Management-image20.png)
...
4. V pogovornem oknu **Hitro ustvarjanje: član projektne ekipe**, ki se prikaže, v polju **Vloga** izberite vlogo za splošni vir. V polju **Enota vira** izberite organizacijsko enoto za splošni vir. Nato izberite **Shrani**.
    ...
    ![Generični član ekipe v zavihku »Ekipa«.](media/Resource-Management-image26.png)
...
5. Na zavihku **Ekipa** izberite splošni vir in nato **Ustvari zahtevo**.
    ...
    ![Povezava za pogoj vira.](media/Resource-Management-image29.png)
    ...
    ![Dodelitve splošnega vira so zamenjane s poimenovanim virom na zavihku razporeda.](media/Resource-Management-image31.png)
    ...
    ![Splošnemu viru »Funkcionalno« je dodano 80-urno petdnevno opravilo.](media/Resource-Management-image32.png)
    ...
    ![Dva poimenovana vira v zavihku »Ekipa«.](media/Resource-Management-image36.png)

    Na zavihku **Načrtovanje** splošni vir ostane dodeljen opravilu.

    ![Splošni viri na zavihku razporeda.](media/Resource-Management-image37.png)
...
![Ukaz »Sprememba stanja«.](media/Resource-Management-image42.png)
...
![Vnos izbirnih komentarjev.](media/Resource-Management-image46.png)
...
![Stanje generičnega člana ekipe se je spremenilo v »Potreben pregled«.](media/Resource-Management-image48.png)
