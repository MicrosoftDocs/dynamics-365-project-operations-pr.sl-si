...
Ali iščete vire, ki bi vam bili v pomoč pri načrtovanju uvedbe? Oglejte si te vodnike, ki jih lahko prenesete.
 ...
 [Vodnik za načrtovanje in sledenje projektov](../project-service/implementation-guides/project-planning-tracking.md)

 [Osnovni vodnik za ponudbe, cene in zaračunavanje](../project-service/implementation-guides/begin-quoting-pricing-billing.md)

 [Napredni vodnik za ponudbe, cene in zaračunavanje](../project-service/implementation-guides/adv-quoting-pricing-billing.md)

 [Vodnik za upravljanje virov](../project-service/implementation-guides/resource-management-guide.md)

 [Vodnik za poročanje](../project-service/implementation-guides/reporting-guide.md)

 [Opombe za razvijalce](../project-service/developer-guides/overview-dev-notes-v3.x.md)
...
## <a name="guidance-for-earlier-versions-app-version-2x-or-1x"></a>Smernice za starejše različice (aplikacija različice 2.x ali 1.x)
 ...
 [Ure, strošek in sodelovanje](../project-service/time-expense-collaboration-guide.md)

 [Informativni dokumenti (aplikacija različice 2.x ali 1.x)](../project-service/white-papers.md)

 [Opombe za razvijalce (različica aplikacije 2.x)](../project-service/developer-guides/add-custom-qoi-forms-v2.x.md)
