...
4. Če ima vaše polno uporabniško ime »Spencer Low« drugačen ID uporabnika kot **»spencerl«**, boste morali posodobiti dodatno datoteko. Odprite **DemoDataPreImportConfig.xml** in poiščite oznako **userstocreateandconfigure**. Posodobite oznako **\<prijava\>** s spremenljivko prijavniId (razlikovanje med velikimi in malimi črkami). 
