...
---
# <a name="actuals"></a>Opravljeno delo
...
## <a name="using-journals-to-record-costs"></a>Uporaba dnevnikov za zapisovanje stroškov

V aplikaciji PSA lahko v dnevnike beležimo stroške ali prihodke v razredih transakcij za material, dajatve, čas, stroške ali davke. Dnevnik vsebuje glavo, vrstice in ukaz za **potrditev**. Tukaj je nekaj scenarijev, v katerih lahko uporabite dnevnik:
