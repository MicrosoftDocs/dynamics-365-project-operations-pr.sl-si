...
description: Ta članek vsebuje informacije o tem, kako uvesti preskusno različico aplikacije Dynamics 365 Project Operations.
author: ruhercul
ms.date: 01/10/2022
ms.topic: article
...
V tem članku je pojasnjeno, kako se naročiti na partnersko ponudbo predogledne različice in kako uvesti okolje storitve Dynamics 365 Project Operations.

Z novo preskusno različico aplikacije Project Operations lahko samodejno uvedete kateregakoli od treh podprtih primerov uvajanja, in sicer tako, da izpolnite vprašalnik, ki ponuja najboljši pristop uvajanja. Ta članek vam bo podal odgovore na vprašanja, kako:
...
4.  Za preverjanje veljavnosti uvajanja izberite ustrezni URL storitve Microsoft Dataverse in URL-je aplikacij za finance in postopke.

## <a name="configuring-dual-write"></a>Konfiguracija dvojnega zapisovanja
- Če želite konfigurirati varnostne vloge za dvojno zapisovanje, glejte [Posodobitev varnostnih nastavitev v storitvi Project Operations na Dataverse](resource-provision-new-environment.md#update-security-settings-on-project-operations-on-dataverse).
- Za dostop do konfiguracije dvojnega zapisovanja se pomaknite do primerka financ in postopkov, nato se pomaknite do možnosti **Upravljanje podatkov** > **Dvojno zapisovanje**.
- Če želite konfigurirati preslikave za dvojno zapisovanje, glejte [Zagon preslikav za dvojno zapisovanje v aplikaciji Project Operations](resource-provision-new-environment.md#run-project-operations-dual-write-maps).
...
1. Za dodeljevanje licenc uporabnikom obiščite [Microsoft 365 skrbniško središče](https://portal.office.com/).
...
### <a name="what-if-i-require-alm-or-elm-for-my-finance-and-operations-apps-environment"></a>Kaj, če za okolje aplikacij za finance in postopke potrebujem ALM ali ELM?
...
1. Odprite **Microsoft 365 skrbniško središče** in izberite **Obračunavanje** > **Vaši izdelki**.
